...
const staticProducts = [
  {
    ...
    category: "Wellness",
    price: "899",
    description: "Om Ayurveda OMEGA 3 capsules are formulated to provide essential fatty acids that your body cannot produce on its own. Each softgel delivers a balanced combination of EPA and DHA to support overall health and well-being. Ideal for daily use, these capsules help maintain cardiovascular health, improve cognitive function, and support joint flexibility.",
    shortDescription: "Boost your daily wellness with high-quality OMEGA 3. Rich in EPA & DHA for brain, heart & joint health.",
    ingredients: [
      "Fish Oil (1000mg)",
      "EPA (180mg)",
      "DHA (120mg)",
      "Other OMEGA 3 Fatty Acids (700mg)"
    ],
    benefits: [
    ...
    images: [
      "/images/products/omega-3-front.png",
      "/images/products/omega-3-side.png",
      "/images/products/omega-3-details.png"
    ],
    faq: [
      { q: "How to use?", a: "Take 1–2 capsules daily after meals or as directed." },
      { q: "Nutritional Info (Per Softgel)", a: "Energy: 9 kcal, Fat: 1 g, Protein: 0 g." },
      { q: "Warning", a: "Consult a doctor if pregnant, lactating, or under medication." }
    ],
    reviews: []
  },
  {
    ...
    category: "Wellness",
    price: "750",
    description: "Om Ayurveda Liver Tablets are a powerful Ayurvedic formulation designed to support and protect liver health naturally. Enriched with traditional herbs like Milk Thistle, Kalmegh, and Bhringraj, this supplement helps detoxify the liver and improve its overall function. Regular use assists in maintaining a healthy liver and improving digestion.",
    shortDescription: "Herbal Liver Tablets for detox & support with Milk Thistle & Kalmegh.",
    ingredients: [
      "Silymarin (150mg)",
      "Kalmegh Extract (100mg)",
      "Dandelion (80mg)",
      "Bhumi Amla (50mg)",
      "Kutki & Kasni (50mg each)",
      "Guduchi & Punarnava"
    ],
    benefits: [
      ...
      "Manages Fatty Liver Toxins",
      "Natural Ayurvedic Herbs",
      "Body Cleansing Support"
    ],
    images: [
      "/images/products/liver -front.png",
      "/images/products/liver 2.png",
      "/images/products/liver 3.png",
      "/images/products/liver 4.png"
    ],
    faq: [
      { q: "Usage Instructions", a: "Take 1 tablet twice daily after meals." },
      { q: "Storage", a: "Store in a cool & dry place away from sunlight." },
      { q: "Disclaimer", a: "Ayurvedic proprietary medicine. Use under medical supervision." }
    ],
    reviews: []
  },
  {
    ...
    price: "1,450",
    description: "Om Ayurveda JOINT Pro is a high-potency Ayurvedic formulation designed for comprehensive joint health. It targets the root cause of inflammation and stiffness to restore natural mobility and strength. Each bottle contains 90 premium golden tablets.",
    shortDescription: "Advanced support for JOINT Pro Relief & Mobility. 90 Golden Tablets.",
    ingredients: [
      "Glucosamine HCL (1400mg)",
    ...
    benefits: [
      "Joint Pain Relief | जोड़ों के दर्द में राहत",
      "Strengthens Bone Health | हड्डियों की मजबूती",
      "Improves Joint Mobility | जोड़ों की जकड़न में कमी",
      "Rapid Muscle Recovery | मांसपेशियों की थकान में सुधार",
      "Reduces Inflammation | सूजन में कमी",
      "Supports Overall Joint Health | जोड़ों का पूर्ण स्वास्थ्य"
    ],
    images: [
      "/images/products/joint-pro-front.png",
      "/images/products/joint-pro-tablets.png",
      "/images/products/joint-pro-labels.png"
    ],
    faq: [
      { q: "Who is this useful for? (किसके लिए उपयोगी?)", a: "• Arthritis patients (गठिया के मरीज)\n• People with knee/back pain (गठिया के दर्द)\n• Elderly individuals (बुजुर्ग व्यक्ति)\n• High physical activity users (ज्यादा शारीरिक काम करने वाले)" },
      { q: "What is the recommended dosage?", a: "Unless suggested by a Vaidhya, take 1 or 2 servings (2-4 tablets) daily after meals." },
      { q: "Supplement Facts (serving size: 2 tablets)", a: "Glucosamine: 1400mg, Chondroitin: 400mg, MSM: 400mg, Boswellia: 200mg. Pure & Potent." }
    ],
    reviews: [
      { name: "Karan M.", rating: 5, comment: "Relief for my father's knee pain in just 10 days! Truly effective.", date: "5 days ago" }
    ]
  },
  {
    id: 4,
    ...
    category: "Pain Relief",
    price: "950",
    description: "Om Ayurveda ORTHO tablets are a powerful Ayurvedic formulation crafted to support joint health and provide relief from pain, stiffness, and inflammation. Enriched with traditional herbs like Swarnamakshik Bhasma, Shallaki, and Nirgundi, this supplement helps improve flexibility and mobility. Ideal for people experiencing arthritis or muscle pain.",
    shortDescription: "ORTHO Joint Pain Relief & Bone Support with Swarnamakshik Bhasma & Shallaki.",
    ingredients: [
      "Shallaki / Salai Guggul (1400mg)",
      "Swarnamakshik Bhasma (40mg)",
      "Chopchini & Ashwagandha (40mg)",
      "Nirgundi & Shilajit (30mg)",
      "Hadjod & Moringa (30mg)",
      "Rasna & Dashmool (30mg)"
    ],
    benefits: [
      ...
      "Helps with Arthritis & Stiffness",
      "Muscle Pain Recovery",
      "Powerful Ayurvedic Herbs"
    ],
    images: [
      "/images/products/ortho-front.png",
      "/images/products/ortho 2.png",
      "/images/products/ortho 3.png",
      "/images/products/ortho 4.png"
    ],
    faq: [
      { q: "Usage", a: "1 tablet twice daily or as directed." },
      { q: "Indications", a: "Joint pain, Arthritis, Back pain, Sciatica, Stiffness." },
      { q: "Storage", a: "Store in a cool, dry & dark place out of reach of children." }
    ],
    reviews: []
  },
  {
    ...
    ingredients: [
      ...
      "Pippali",
      "Ginger Extract",
      "Honey base / Syrup base"
    ],
    benefits: [
      "Helps relieve cough & throat irritation",
      "Supports respiratory health",
      "Helps reduce mucus & congestion",
      "Soothes dry & wet cough",
      "Comfort during cold & seasonal changes",
      "Made with natural Ayurvedic herbs"
    ],
    images: [
      "/images/products/cough-har-box.png",
      "/images/products/cough-har-front.png",
      "/images/products/cough-har-details.png"
    ],
    faq: [
      { q: "Usage Instructions", a: "Adults: 1–2 teaspoons (5–10 ml) twice daily. Children: As directed by physician." },
      { q: "Storage", a: "Store in a cool & dry place away from direct sunlight. Close cap tightly." },
      { q: "Warning", a: "Keep out of reach of children. Consult doctor if symptoms persist." }
    ],
    reviews: []
  },
  {
    ...
    category: "Wellness",
    price: "450",
    description: "Om Ayurveda OM HAIR OIL is a specially formulated herbal blend designed to nourish the scalp and strengthen hair from the roots. Infused with traditional Ayurvedic ingredients like Bhringraj and Amla, this oil helps reduce hair fall, control dandruff, and promote natural hair growth. The easy comb applicator ensures precise and mess-free application.",
    shortDescription: "OM HAIR OIL for anti hair fall, dandruff control & growth with easy comb applicator.",
    ingredients: [
    ...
    benefits: [
      ...
      "Nourishes Scalp",
      "Easy Comb Applicator"
    ],
    images: [
      "/images/products/hair-oil-front.png",
      "/images/products/hair-oil-side.png",
      "/images/products/hair-oil-details.png"
    ],
    faq: [
      { q: "How to use?", a: "Apply directly to scalp using comb applicator. Massage for 5–10 mins. Leave for 2–3 hours or overnight." },
      { q: "Frequency?", a: "Use 2–3 times a week for best results." },
      { q: "Warning", a: "Perform a patch test before use. Avoid contact with eyes." }
    ],
    reviews: []
  },
  {
    ...
    price: "1,200",
    description: "Om Ayurveda OM POWER OIL is a specially formulated Ayurvedic oil designed to enhance physical strength, improve circulation, and promote overall vitality. Made with a blend of Ashwagandha and Bala, this oil deeply penetrates the skin to relax muscles and reduce fatigue.",
    shortDescription: "Ayurvedic OM POWER OIL for Strength, Energy & Vitality.",
    ingredients: [
      "Ashwagandha (100mg)",
      "Bala Extract (75mg)",
      "Jaiphal & Lavang (50mg each)",
      "Dalchini Extract (50mg)",
      "Aloe Vera & Malkangni",
      "Sesame Oil Base"
    ],
    benefits: [
    ...
    images: [
      "/images/products/om power oil  -front.png",
      "/images/products/om power oil  (1).png",
      "/images/products/om power oil  (3).png"
    ],
    faq: [
      { q: "Application Instructions", a: "Take 2–3 drops and massage gently on required area 1–2 times daily." },
      { q: "Storage", a: "Store in a cool & dry place away from sunlight." },
      { q: "Disclaimer", a: "External use only. Results may vary." }
    ],
    reviews: []
  },
  {
    ...
    category: "Pain Relief",
    price: "550",
    description: "Om Ayurveda OM INJURY OIL is a powerful Ayurvedic formulation specially designed to provide relief from joint and muscle pain. Enriched with traditional oils like Mahanarayan Tel and Mahavishgarbh Tel, it helps reduce stiffness, inflammation, and discomfort from injuries.",
    shortDescription: "Fast-absorbing OM INJURY OIL for Muscle Pain, Back Pain & Arthritis Support.",
    ingredients: [
      "Mahanarayan Tel (3ml)",
      "Mahavishgarbh Tel (2.5ml)",
      "Panchgun Tel (2.5ml)",
      "Gandh Purn Oil (1ml)",
      "Nilgiri (Eucalyptus) Oil (0.5ml)",
      "Camphor"
    ],
    benefits: [
      ...
      "Improves Mobility",
      "Warming & Soothing Effect",
      "Suitable for Daily Use"
    ],
    images: [
      "/images/products/om injury-front.png",
      "/images/products/om injury  (1).png",
      "/images/products/om injury  (2).png",
      "/images/products/om injury  (4).png"
    ],
    faq: [
      { q: "Usage", a: "Apply 3–5 ml on affected area and massage gently 1–2 times daily." },
      { q: "Indications", a: "Joint pain, Back pain, Muscle stiffness, Sports injuries." },
      { q: "Warning", a: "Avoid open wounds. Keep out of reach of children." }
    ],
    reviews: []
  },
  {
    ...
    price: "350",
    description: "Om Ayurveda OM DETOX ( CHURNA ) is a powerful Ayurvedic formulation designed to cleanse the digestive system and support overall gut health. Made with a blend of traditional herbs, it helps improve digestion, regulate bowel movements, and reduce issues like acidity and constipation. This herbal detox powder works gently to eliminate toxins from the body while promoting better nutrient absorption and digestive balance.",
    shortDescription: "Natural OM DETOX ( CHURNA ) to support digestion, bowel movement, and overall gut health.",
    ingredients: [
      ...
      "Swarn Bang (Gold Bhasma)",
      "Shankh Bhasma & Praval Pishti"
    ],
    benefits: [
      "Supports body detoxification",
      "Helps improve digestion",
      "Relieves acidity & gas",
      "Supports healthy bowel movement",
      "Helpful in piles control",
      "Reduces indigestion headaches"
    ],
    images: [
      "/images/products/detox-churna-front.png",
      "/images/products/detox-churna-side.png",
      "/images/products/detox-churna-box.png"
    ],
    faq: [
      { q: "Usage Instructions", a: "Take 1–2 spoons at night before sleep with lukewarm water, or as directed by physician." },
      { q: "Safety Info", a: "For Ayurvedic use only. Consult doctor if pregnant or under medication." },
      { q: "Storage", a: "Store in a cool & dry place. Close cap tightly after use." }
    ],
    reviews: []
  },
  {
    ...
    category: "Wellness",
    price: "650",
    description: "Om Ayurveda GOKSHURA capsules are formulated using high-quality extract of GOKSHURA (Tribulus terrestris), traditionally used to support urinary tract health and kidney function. This natural supplement helps maintain fluid balance and supports overall vitality.",
    shortDescription: "Natural Urinary & Kidney Support GOKSHURA Supplement.",
    ingredients: [
      "Gokshura Extract (500mg)",
      "Pure Herb Base",
      "Excipients q.s."
    ],
    benefits: [
